...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-1 flex items-center justify-center bg-[#f5f5f0] p-4 lg:p-8 relative">
        {/* Back to Home Button */}
        <button
          onClick={() => router.push('/')}
          className="absolute top-4 left-4 sm:top-6 sm:left-6 flex items-center gap-2 text-black hover:text-gray-700 transition-colors group"
        ...
        >
          ...
          <span className="font-medium text-sm sm:text-base" style={{ fontFamily: "Poppins, sans-serif" }}>
            Back to Home
          </span>
        </button>
