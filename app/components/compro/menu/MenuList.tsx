          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-80 bg-[url('/images/wood-texture.jpg')] bg-cover bg-center">
                ...
                <button
                  onClick={() => setSelectedItem(null)}
                  className="absolute top-4 right-4 z-20 bg-black bg-opacity-70 text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-opacity-90 transition-all hover:scale-110"
                >
